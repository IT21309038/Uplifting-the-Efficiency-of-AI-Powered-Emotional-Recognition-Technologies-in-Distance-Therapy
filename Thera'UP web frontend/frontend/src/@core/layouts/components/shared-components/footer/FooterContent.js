  ...
  return (
    <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
      <Typography sx={{ mr: 2, display: 'flex', color: 'text.secondary' }}>
        ...
        {`by`}
        <Typography sx={{ mx: 1 }} target='_self' href='#' component={StyledCompanyName}>
          KIU Software Engineering Division
        </Typography>
        {`|`}
        <Typography sx={{ mx: 1 }} target='_self' href='/changelog' component={StyledCompanyName}>
          Version {Version}
        </Typography>
      </Typography>
      {hidden ? null : (
