...
import 'package:thera_up/pages/Question_list/q7Social.dart';

class Q6Memory extends StatefulWidget {
  ...
  const Q6Memory({super.key, this.selectedSleepOption, this.selectedEatOption, this.selectedOverwhelmedOption, this.selectedAngryOption, this.selectedFocusOption});

  @override
  State<Q6Memory> createState() => _Q6MemeryState();
}

class _Q6MemeryState extends State<Q6Memory> {
  String? _selectedMemoryOption;
    ...
    return Column(
      children: [
        ClipRRect(
          ...
          child: Image.asset(
            'assets/images/memory.jpg', // Add your image in assets folder
            height: 200,
          ),
        ),
        const SizedBox(height: 20),
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => Q7Social(
              ...
              selectedMemoryOption: _selectedMemoryOption
